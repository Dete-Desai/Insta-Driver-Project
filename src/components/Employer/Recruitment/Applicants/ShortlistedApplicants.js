...
const ShortlistedApplicants = props => {
    ...
    const onTimeRejectedSelection=(e)=>{
        e.preventDefault();
        setRejectedOn(e.target.value);
        console.log("onTimeRejectedSelection")
        //setApplicants(getApplicants(jobs).filter(applicant=>timeHelpers.isWithinDuration(applicant.timestamp,getDuration(e.target.value))));  
    }
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-auto mb-4">
                        <select id="cid" name="cid" value={appliedOn}
                          className="form-control applicant_select"
                          onChange={onTimeAppliedSelection}>
                          <option value="">Time shortlisted</option>
                          <option value="ONE_HOUR">Last hour</option>
                          <option value="TWELVE_HOURS">12 hrs Ago</option>
                          <option value="ONE_DAY">Today</option>
                          <option value="ONE_WEEK">This Week</option>
...
ShortlistedApplicants.propTypes = {
