...
export const ManagePosts = () => {
  ...
  const inActiveAllJobs = allJobs && allJobs.filter((job) => isExpired(job));
  const activeAllJobs = allJobs && allJobs.filter((job) => !isExpired(job));
  ...
  const onDelete = (jobAdId) => {
    dispatch(deleteJobAd(token, jobAdId));
  };

  const onStopAndArchive = (jobAdId) => {
    dispatch(stopAndArchiveJobAd(token, jobAdId));
  };
              ...
              <div className="container-fluid">
                <div className="container">
                  ...
                  <div id="all_job_ads">
                    ...
                    <div id="no_non_driving_cards" style={{ display: "none" }}>
                      <div className="cards text-center shadow no-active-cards">
                        <div className="card-header">Featured</div>
                        <div className="card-body">
                          <h5 className="card-title">No Non-driving Job Ads</h5>
