...
const HiredCandidates = props => {
    ...
    useEffect(async ()=>{
        ...
        if (responseData){
            ...
            const data = responseData.response_data[0].hired
            setData(data)
...
export default connect(mapStateToProps,{getEmployerJobCandidates})(HiredCandidates)
