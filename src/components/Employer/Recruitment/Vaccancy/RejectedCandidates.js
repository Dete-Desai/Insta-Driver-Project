...
const RejectedCandidates = props => {
    ...
    useEffect(async ()=>{
        ...
        if (responseData){
            ...
            const data = responseData.response_data[0].rejected
            setData(data)
...
export default connect(mapStateToProps,{getEmployerJobCandidates})(RejectedCandidates)
