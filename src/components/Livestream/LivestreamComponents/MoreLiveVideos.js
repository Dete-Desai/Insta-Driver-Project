...
import { changeVideo } from "../../../redux/actions/livestream_actions";

const MoreLiveVideos = () => {
          ...
          <div key={index} className="col-md-4 mx-auto">
            <div className="card">
              <video
                ...
                onClick={() => dispatch(changeVideo(video.id, video.url))}
              ></video>
