    ...
    <div className="daily__target section__style pr-2 pb-3 pt-5 bg-white mt-3">
      <div className="col-md-10 m-auto px-5">
        <h5 className="form__heading">
          Daily Target Payout (For Ride-hailing taxis)
        </h5>
            ...
            <div className="row">
              <div className="col-md-6 col-sm-6 col-6 col-xs-6">
                <div className="form-group row align-items-center">
                  <label
                    className="col-sm-12 col-md-12 col-lg-3 mb-0 label__style text-left"
                    for="minimum"
                  >
                    Minimum
                  </label>
                  <div className="col-sm-12 col-md-12 col-lg-9">
                    <span className="text-gray">
                      {props.data && props.data.MinimumPay}{" "}
              ...
              <div className="col-md-6 col-sm-6 col-6 col-xs-6">
                <div className="form-group row align-items-center">
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-9">
                    <span className="text-gray">
                      {props.data && props.data.MaximumPay}{" "}
                      {props && props.currency}
                    </span>
                  </div>
                </div>
