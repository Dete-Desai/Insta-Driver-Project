...
import'../../dist/css/hiredriver.css';
import Hiredriver_card from './Hiredriver_card';
import props from 'prop-types';
import DriverPop from './DriverPop';

const Hiredrivers= props => {
    return (
        ...
        <div id="content">
            ...
            <form method="get" id="frmSearch" name="frmSearch">
              <div className="form-row">
                ...
                <div className="col-lg-6">
                  <div className="row mt-3" style={{"borderBottomColor":"#AEAEAE","border-bottom":"2px solid #AEAEAE","position":"relative","top":"-10px"}}>
                    <div className="col-5">
                      <div id="nav-item">
                        <a className="driving-jobs" href="jobs.html" style={{"webkitTextDecoration":"none","textDecoration":"none","outline":"none","color":"#4B4747"}}>Driving Jobs</a>
                      </div>
                    </div>
                    <div className="col-6">
                      <div id="nav-item">
                        <a className="hire-driver active"  href="#" style={{"webkitTextDecoration":"none","textDecoration":"none","outline":"none","color":"#4B4747"}}>I'm a driver,hire me</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-1 text-center col-2 ">
                  <img src={process.env.PUBLIC_URL + '/images/filter.svg'} data-toggle="modal" data-target="#filterModal" className="cursorpointer" />
                </div>
          ...
          <div className="container mainjobcards">
