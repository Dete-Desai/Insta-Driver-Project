...
const SocialHistory = ({
  ...
  return (
    <div className="socialHistory section__style pb-3 pt-5 pr-2 bg-white mt-3">
      ...
      {
        userInfo ? get(userInfo, "showSocialSummary") ?
          <div>
          ...
          <div className="col-md-8 px-4 p-4 currencyInfo my-4">
            <p style={{ color: "#969393" }}>This driver has not made his “Get Social” history public to non-drivers. You have to be a driver and have registered a driver account to view his “Get Social” history. <br /> <br />

            Get Social is the social media for drivers. Drivers connect to fellow drivers, inbox each other, join groups to discuss challenges, share opportunies, join group video calls for fun and for getting traffic info, play online multiplayer games, etc</p>
          </div>
          : null
      }
