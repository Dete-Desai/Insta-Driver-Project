            ...
            <div className="row">
              <div className="col-md-6 col-sm-6 col-6 col-xs-6">
                <div className="form-group row align-items-center">
                  ...
                  <span className="text-gray">{driver && driver.dailyTargetPayout && driver.dailyTargetPayout.MininumPay?
                     driver.dailyTargetPayout.MinimumPay:0}</span>
                  </div>
                </div>
              </div>
              <div className="col-md-6 col-sm-6 col-6 col-xs-6">
                <div className="form-group row align-items-center">
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-9">
                  <span className="text-gray">{driver && driver.dailyTargetPayout && driver.dailyTargetPayout.MaximumPay?
                     driver.dailyTargetPayout.MaximumPay:0}</span>
                  </div>
                </div>
              </div>
            </div>
