...
import { SocialCardVideo, SocialCard2, CommentSocialCard2, ReplySocialCard } from '../ComponentsPackages/SocialCards/SocialCardsComponents';

const GroupVideos = props => {
