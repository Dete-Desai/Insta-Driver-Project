...
const InstadriverGroups = (props) => {
  ...
  const directToMediaFiles1 = () => {
    let route = `group-media-files-videos`;
    history.push(route);
  };
  const directToMediaFiles2 = () => {
    let route = `group-media-files-docs`;
    history.push(route);
  };
...
InstadriverGroups.propTypes = {};

export default InstadriverGroups;
