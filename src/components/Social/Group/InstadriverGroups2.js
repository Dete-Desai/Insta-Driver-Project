...
const InstadriverGroups2 = (props) => {
      ...
      <main role="main" className="col-lg-12  px-1" style={{ right: 80 }}>
        ...
        <div className="row">
          <div className="col-md-12" style={{ left: "20%" }}>
            ...
            <br />
            <button
              onClick={directToInstadriverGroups3}
              className="social-button2 social-button-2"
              style={{ fontSize: 20, width: 250, height: 35 }}
            >
              View 5 More Replies
            </button>
            <br />
...
InstadriverGroups2.propTypes = {};

export default InstadriverGroups2;
