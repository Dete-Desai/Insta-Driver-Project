            ...
            <main role="main" className="col-lg-12  px-1" style={{ right: 80 }}>
                ...
                <div className="row">
                    <div className="col-md-12" style={{ left: '20%' }}>
                        ...
                        <div className="row">
                            <div className="col-md-12" style={{ left: '12%' }}>
                                <div className="btn-group">
                                    ...
                                    <button onClick={directToMediaFiles2} className="social-button">Docs</button>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <br />
                        <div className="row">
                            <div className="col-md-4" style={{ right: 100 }}>
                                <i className="fa fa-file-pdf-o" style={{ fontSize: 70, color: 'red' }} />
                            </div>
                            <div className="col-md-4" style={{ right: 150 }}>
                                <font size="6" color="#5c645d">Driver Uber Contract</font>
                            </div>
                            <div className="col-md-4">
                                <font size="6" color="#5c645d">1st June 2020</font>
                            </div>
                        </div>
                        <br />
                        <br />
                        <div className="row">
                            <div className="col-md-4" style={{ right: 100 }}>
                                <i className="fa fa-file-text" style={{fontSize: 75, color: 'rgb(124, 162, 219)', backgroundColor: 'white'}} />
                            </div>
                            <div className="col-md-4" style={{ right: 150 }}>
                                <font size="6" color="#5c645d">Driver Uber Contract</font>
                            </div>
...
GroupMediaFiles2.propTypes = {

}

export default GroupMediaFiles2
