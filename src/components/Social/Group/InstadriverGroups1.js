...
const InstadriverGroups1 = (props) => {
  ...
  const directToInstadriverGroups2 = () => {
    let route = `instadriver-group-comment-reply`;
    history.push(route);
  };
      ...
      <main role="main" className="col-lg-12  px-1" style={{ right: 80 }}>
        ...
        <div className="row">
          <div className="col-md-12" style={{ left: "20%" }}>
            ...
            <br />
            <button
              onClick={{ directToInstadriverGroups2 }}
...
InstadriverGroups1.propTypes = {};

export default InstadriverGroups1;
