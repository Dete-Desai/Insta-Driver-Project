...
import { AboutCard5 } from '../ComponentsPackages/AboutCards/AboutCardsComponents';

const MembersGroup = props => {
            ...
            <main role="main" className="col-lg-12  px-1" style={{ right: 80 }}>
                ...
                <div className="row">
                    <div className="col-md-12" style={{ left: '0%' }}>
                        <br />
                        <div className="row">
                            <div className="col-sm-12" style={{ left: '10%' }}>
                                <SearchPage />
                            </div>
                        </div>
                        <br />
