...
const GroupMediaFiles1 = props => {
    ...
    const directToVideo = () => { let route = `group-video-post`; history.push(route); }
                    ...
                    <div className="col-md-12" style={{ left: '20%' }}>
                        ...
                        <div className="row">
                            <div className="col-md-12" style={{ left: '12%' }}>
                                <div className="btn-group">
                                    <button onClick={directToMediaFiles} className="social-button1">Photos</button>
                                    <button onClick={directToMediaFiles1} className="social-button">videos</button>
                        ...
                        <div className="row">
                            <div className="col-md-3" style={{ right: 150 }}>
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v1.png" alt="Card image cap" />
                            </div>
                            <div className="col-md-3">
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v2.png" alt="Card image cap" />
                            </div>
                            <div className="col-md-3" style={{ left: 150 }}>
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v3.png" alt="Card image cap" />
                            </div>
                        </div>
                        <br />
                        <br />
                        ...
                        <div className="row">
                            <div className="col-md-3" style={{ right: 150 }}>
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v4.png" alt="Card image cap" />
                            </div>
                            <div className="col-md-3">
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v5.png" alt="Card image cap" />
                            </div>
                            <div className="col-md-3" style={{ left: 150 }}>
                                <img onClick={directToVideo} className="media-photo-size" src="dist/images/v6.png" alt="Card image cap" />
                            </div>
                        </div>
                        <br />
                        <br />
...
GroupMediaFiles1.propTypes = {

}

export default GroupMediaFiles1
