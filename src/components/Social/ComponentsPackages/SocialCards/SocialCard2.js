...
const SocialCard2Component = (props) => {
  ...
  return (
    <div>
      <div className="social-card2"Component border-radius="10px">
        {/* Card content */}
...
SocialCard2Component.propTypes = {};

export default SocialCard2Component;
